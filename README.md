...
The library can be linked with ANSI C, C++, [C#](https://github.com/ImageOptim/libimagequant/blob/master/libimagequant.cs), [Rust](https://github.com/pornel/libimagequant-rust), [Java](https://github.com/ImageOptim/libimagequant/tree/master/org/pngquant),[Android](https://github.com/HayDar-Android/PNGQuantAndroid) and [Go](https://code.ivysaur.me/go-imagequant/) programs. It has no external dependencies.
